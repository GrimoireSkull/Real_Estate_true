  ...
  return (
    <div className = "py-3 sm:py-5">
        <div className = "grid grid-cols-4 gap-4">
            {rentalsData.map((rental) => <UpdateRental Id = {rental.Id} title = {rental.title} image = {rental.image[0]} price = {rental.price} views = {rental.viewCount} tag = {rental.tags[0]}/>)}
        </div>
    </div>
  )
}

export {rentalsData, UpdateRentals};